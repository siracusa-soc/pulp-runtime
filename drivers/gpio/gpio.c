...
uint32_t configure_gpio(uint32_t number, uint32_t direction){
  ...
  reg = bitfield_field32_write(reg, field, (direction == GPIO_DIRECTION_INPUT)? GPIO_GPIO_MODE_0_MODE_0_VALUE_INPUT_ONLY: GPIO_GPIO_MODE_0_MODE_0_VALUE_OUTPUT_ACTIVE);
